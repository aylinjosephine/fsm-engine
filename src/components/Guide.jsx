...
function Page1() {
  return (
    <>
      <h1 className="font-github text-white font-bold text-3xl text-center">FSM Engine</h1>
      ...
      <p className="font-github text-white text-balance text-center w-150">
        Welcome to FSM Engine! A Web Based Editor to Draw Finite State Machines. The Following
        tutorial will help you familiarize yourself with the editor.
      </p>
    </>
  )
}
...
function Page2() {
  return (
    <>
      <h1 className="font-github text-white font-bold text-3xl text-center">Video Tutorial</h1>
      ...
      <p className="font-github text-white text-balance text-center w-150">
        The above video explains the core functions of FSM Engine and how to use it.
      </p>
    </>
  )
}
...
function Page3() {
  return (
    <>
      <h1 className="font-github text-white font-bold text-3xl text-center">Support FSM Engine</h1>
      ...
      <p className="font-github text-white w-150 text-center text-sm">
        Hey there! I'm Karthik, the <b>creator</b> of <b>FSM Engine</b> — thank you so much for
        checking it out!
      </p>

      <p className="font-github text-white w-150 text-center text-sm">
        {' '}
        If you like what you see, consider leaving a ⭐ on the repo and help spread the word by
        sharing FSM Engine with your friends!
      </p>

      <p className="font-github text-white w-150 text-center text-sm">
        Found a bug or something that doesn't feel right? Feel free to open an issue on GitHub —
        I'll do my best to look into it.
      </p>

      <p className="font-github text-white w-150 text-center text-sm">
        Interested in contributing? I'd love that! Open a pull request and let's make FSM Engine
  ...
  return (
    <>
      ...
      <p className="font-github text-white font-semibold text-base w-[90%] text-center">
        Pro Tip: Use Alt+S for Add state, Alt+Z for Undo, Alt+R for Remove mode (with undo in
        the background), Alt+Y for Redo, and Alt+A for Auto Layout.
      </p>
    </>
  )
}
