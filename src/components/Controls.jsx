...
import { CircleCheck, CircleDot, CircleDotDashed, CircleFadingPlus, CircleX } from 'lucide-react'
    ...
    if (FSMType !== EngineMode.type) {
      setConfirmDialog({
        ...
        onConfirm: () => {
          ...
          if (type === 'NFA' && !finalAlphabets.includes('λ')) finalAlphabets.push('λ')
      ...
      <div className="flex flex-col gap-5 justify-center px-5 py-5 w-110 h-fit bg-primary-bg border border-border-bg rounded-3xl shadow-[0px_0px_50px_0px_#000000]/70 select-none">
        ...
        <span>
          ...
          <input
            ...
            type="text"
          />
          <p className={`font-github text-white text-base py-1 ${FSMType !== 'NFA' && 'hidden'}`}>
        ...
        <span>
          <p className="font-github text-white text-base pb-2">State Machine Type</p>
