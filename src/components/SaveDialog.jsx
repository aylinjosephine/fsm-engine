...
import { deleted_nodes, editor_state, layer_ref, node_list, transition_list } from '../lib/stores'
      ...
      <div className="h-full w-fit px-2 bg-surface-1 rounded-xl border border-border-bg shadow-[0px_0px_50px_0px_#00000080] flex justify-center items-center gap-3">
        ...
        <button
          ...
          onClick={() => {
            ...
            link.download =
              saveDetails.type === 'json' ? `${saveDetails.name}.fsm` : saveDetails.name // Set File Name
