...
// Fixed input/output bit counts, set once by the app (init menu or import).
// All editor bit inputs are limited to these values.
export const input_bit_count = atom(1)
export const output_bit_count = atom(1)
